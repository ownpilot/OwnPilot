            ...
            >
              ...
              <div
                className={`text-[10px] mt-1 ${
                  msg.sender === 'user' ? 'text-white/60' : 'text-text-muted dark:text-dark-text-muted'
                }`}
              >
          ...
          <div className="flex justify-start">
            <div className="bg-bg-secondary dark:bg-dark-bg-secondary text-text-muted dark:text-dark-text-muted px-3 py-2 rounded-2xl rounded-bl-md text-sm">
              <span className="inline-flex gap-1">
                <span className="w-1.5 h-1.5 bg-text-muted dark:bg-dark-text-muted rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                <span className="w-1.5 h-1.5 bg-text-muted dark:bg-dark-text-muted rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                <span className="w-1.5 h-1.5 bg-text-muted dark:bg-dark-text-muted rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
              </span>
            </div>
          </div>
        )}
