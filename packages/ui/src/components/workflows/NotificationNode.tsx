    ...
    >
      ...
      <div className="px-3 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-sm text-purple-900 dark:text-purple-100 truncate flex-1">
        ...
        {data.severity && (
          <div className="flex items-center gap-1.5 mt-1">
            <span className="px-1.5 py-0.5 text-[9px] font-bold rounded bg-purple-500/20 text-purple-700 dark:text-purple-300 uppercase">
        ...
        {data.message && (
          <p className="text-[10px] text-text-muted dark:text-dark-text-muted mt-1 truncate">
