...
import { Settings, Check, AlertCircle, ChevronDown, ChevronRight, Key, Link, Image, Cpu, Server } from '../components/icons';
...
type SettingsTab = 'api-keys' | 'providers' | 'integrations' | 'media' | 'ai-models';
