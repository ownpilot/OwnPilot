/**
 * CreateAgentWizard — multi-step modal for creating soul agents
 */
...
import { Bot, X, ChevronRight, CheckCircle2, BookOpen } from '../../../components/icons';
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-t border-border dark:border-dark-border">
          ...
          {step !== 'type' && step !== 'templates' && (
            <button
              onClick={() => {
                if (step === 'identity') setStep('config');
