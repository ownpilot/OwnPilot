/**
 * Core tool definitions and executors
 *
 * Contains CORE_TOOLS (tool definitions) and CORE_EXECUTORS (implementations)
 * for built-in utility tools. Extracted from tools.ts for maintainability.
 */
