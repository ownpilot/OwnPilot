 ...
 *
 * Intelligent memory system that helps the AI assistant remember and understand users.
 *
 * FEATURES:
 * - Conversation summarization and storage
 * - User fact extraction and tracking
 ...
 *
 * MEMORY TYPES:
 * - Facts: Specific information about the user (name, preferences, etc.)
 * - Episodes: Summaries of past conversations/interactions
 * - Skills: Learned capabilities and how to help the user
 * - Preferences: User's likes, dislikes, and working styles
 */
