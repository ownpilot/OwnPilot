...
describe('defaults — types', () => {
  ...
  describe('all numeric values are finite', () => {
    const allNumeric = [
      ...
      WS_PORT, WS_HEARTBEAT_INTERVAL_MS, WS_SESSION_TIMEOUT_MS,
      WS_MAX_PAYLOAD_BYTES, WS_MAX_CONNECTIONS, WS_CLOSE_SESSION_TIMEOUT,
      WS_RATE_LIMIT_MESSAGES_PER_SEC, WS_RATE_LIMIT_BURST, WS_MAX_METADATA_VALUE_BYTES,
      SCHEDULER_CHECK_INTERVAL_MS, SCHEDULER_DEFAULT_TIMEOUT_MS, SCHEDULER_MAX_HISTORY_PER_TASK,
      TRIGGER_POLL_INTERVAL_MS, TRIGGER_CONDITION_CHECK_MS,
      PLAN_STEP_TIMEOUT_MS, PLAN_MAX_STALL, PLAN_STALL_RETRY_MS,
      PLAN_MAX_BACKOFF_MS, PLAN_MAX_LOOP_ITERATIONS,
      RATE_LIMIT_WINDOW_MS, RATE_LIMIT_MAX_REQUESTS, RATE_LIMIT_BURST,
      TOOL_ARGS_MAX_SIZE,
      MS_PER_MINUTE, MS_PER_HOUR, MS_PER_DAY, MAX_DAYS_LOOKBACK,
      MAX_PAGINATION_OFFSET,
      MAX_AGENT_CACHE_SIZE, MAX_CHAT_AGENT_CACHE_SIZE,
      AGENT_DEFAULT_MAX_TOKENS, AGENT_CREATE_DEFAULT_MAX_TOKENS,
      AGENT_DEFAULT_TEMPERATURE, AGENT_DEFAULT_MAX_TURNS, AGENT_DEFAULT_MAX_TOOL_CALLS,
      MAX_BATCH_TOOL_CALLS,
      IMAP_CONNECT_TIMEOUT_MS,
      MAX_TOOL_SOURCE_FILE_CACHE, MAX_TOOL_SOURCE_EXTRACTION_CACHE, MAX_MESSAGE_CHAT_MAP_SIZE,
      EMBEDDING_DIMENSIONS, EMBEDDING_MAX_BATCH_SIZE, EMBEDDING_RATE_LIMIT_DELAY_MS,
      EMBEDDING_MAX_CHUNK_CHARS, EMBEDDING_MIN_CHUNK_CHARS, EMBEDDING_CACHE_EVICTION_DAYS,
      RRF_K, EMBEDDING_QUEUE_BATCH_SIZE, EMBEDDING_QUEUE_INTERVAL_MS, EMBEDDING_QUEUE_MAX_SIZE,
    ];
