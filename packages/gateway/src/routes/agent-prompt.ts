...
Supported names: metric_grid, table, list, checklist, key_value, cards, steps, callout, progress, bar_chart, timeline. Use key_value for facts, cards for compact comparisons, and steps for ordered plans. The data attribute must be valid JSON wrapped in single quotes. Apostrophes inside JSON string values (e.g. Turkish "09:00'da", French "l'heure") must be backslash-escaped as \' so they don't terminate the attribute — write data='{"body":"09:00\'da..."}' not data='{"body":"09:00'da..."}'. Never put widgets inside code fences. Do not use shorthand tags like <callout />; always use <widget name="..." data='...' />.
