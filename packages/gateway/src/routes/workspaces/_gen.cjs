const fs=require("fs"),p=require("path"),d="D:/Codebox/PROJECTS/OwnPilot/packages/gateway/src/routes/workspaces";
function w(n,c){fs.writeFileSync(p.join(d,n),c);console.log("Written "+n+": "+c.length+" bytes")}
const S=String.fromCharCode;const Q=S(39),N=S(10);
