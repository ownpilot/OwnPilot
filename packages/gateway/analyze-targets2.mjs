...
const targets = ['personal-data.ts','debug.ts','health.ts','settings.ts','dashboard.ts','plugins.ts','tools.ts','agent-service.ts','workflow-service.ts','background-agent-manager.ts'];
