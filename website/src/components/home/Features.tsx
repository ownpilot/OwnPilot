...
import {
  Brain, Wrench, Shield, Zap, Globe, Database, Bot, MessageSquare,
  GitBranch, Cpu, Wifi, Mic, Chrome, Code, Users, Activity,
  BarChart3, Lock, Network, Layers
} from "lucide-react";
  ...
  return (
    ...
    >
      <Card hover className="h-full group">
        <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-4 transition-transform duration-200 group-hover:scale-110`}>
        ...
        <div ref={headerRef} className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-[var(--color-text)] mb-4">
              ...
              <span className="text-gradient">not a SaaS</span>
            </h2>
            <p className="text-lg text-[var(--color-text-muted)] leading-relaxed">
              OwnPilot runs entirely on your infrastructure. No data sent to third parties,
              no subscription fees, no vendor lock-in. Just a powerful, extensible AI assistant
